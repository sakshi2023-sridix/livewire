        ...
        <div class="row justify-content-center mt-3">
            <div class="py-6">
                    <nav class="bg-white shadow-md rounded-lg p-1 mb-6 flex justify-between">
                        ...
                        <a href="{{ route('posts.create') }}" class="btn btn-primary btn-sm text-gray-700 px-2">Create Post</a>
                        <a href="{{ route('user.posts', ['userId' => '']) }}" class="btn btn-primary btn-sm text-gray-700 px-2">My Posts</a>
                    </nav>
                </div>
            </div>
        </div>
